...
-- Dumping data for table surat-keluar.migrations: ~11 rows (approximately)
...
INSERT INTO `outboxes` (`id`, `index`, `suffix`, `date`, `subject`, `destination`, `document`, `user_id`, `created_at`, `updated_at`, `deleted_at`, `category_id`, `reff`) VALUES
	(1, 409, NULL, '2021-05-03', 'Ket Internal', 'BRI KCP Mentok', NULL, 1, '2021-05-20 03:10:34', '2021-05-20 03:20:00', NULL, 21, 'W28-A4/1/HK.05/V/2021'),
	(2, 410, NULL, '2021-05-03', 'Permohonan Cuti a.n Tibyani S.Ag., M.H.', 'PTA Babel', NULL, 1, '2021-05-20 03:21:00', '2021-05-20 03:21:00', NULL, 53, 'W28-A4/1/KP.05.2/V/2021'),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `is_admin` enum('N','Y') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_email_unique` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table surat-keluar.users: ~8 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `nip`, `position`, `department_id`, `is_active`, `is_admin`, `deleted_at`) VALUES
	(1, 'Adinda Aprilia', 'dinda@pa-mentok.go.id', NULL, '$2y$10$8ojuxFo6H6HTUc/AYc8IH.9g68wZMdtS2yAH21K3yqg1OWlicWMWy', NULL, '2021-04-29 05:40:04', '2021-04-29 05:40:04', NULL, NULL, NULL, 'N', 'N', NULL),
	(2, 'Eko Febrianto, S.H', 'eko@pa-mentok.go.id', NULL, '$2y$10$AaM/tfNN/hfyjypeMVK1dOgzmjB5mwt/GCPb57cG4y/FZWdz296o2', NULL, '2021-04-29 07:06:31', '2021-05-18 08:43:23', '198402292006041002', 'Kasubbag Umum dan Keuangan', NULL, 'Y', 'N', NULL),
	(3, 'Muhammad Rizki, S.Si', 'rizki@pa-mentok.go.id', NULL, '$2y$10$4053RNlFXXYG/QlhWpG.NOGc5hUL.Txo0I5YbOCdqA1qJQ.5w7eUG', NULL, '2021-05-17 09:16:11', '2021-05-18 05:17:07', '199308192020121003', 'Pranata Komputer', NULL, 'Y', 'N', NULL),
	(4, 'HARDIANSYAH ROPI, S.Ak.', 'ropi@pa-mentok.go.id', NULL, '$2y$10$F0.fnm1IJmTvwlmfjQg6WOHfLocEp8Xv80qGGKD6OGkraan9A8tu2', NULL, '2021-05-18 05:19:02', '2021-05-19 06:53:47', '198204032009121003', 'Kasubbag Kepegawaian', 1, 'Y', 'N', NULL),
	(5, 'TIBYANI, S.Ag., M.H.', 'tibyani@pa-mentok.go.id', NULL, '$2y$10$.Fa6zPmb1LHRFQg52CK6CuQ2HnrDjm.JwFc.m9VPis3/5J3Fk5YNW', NULL, '2021-05-20 03:02:36', '2021-05-20 03:02:36', '197207051998031004', 'Ketua', NULL, 'Y', 'N', NULL),
	(6, 'MUHAMAD SYARIF, S.H.I.', 'msyarif@pa-mentok.go.id', NULL, '$2y$10$wA6nUC6orng8qBQjHI45duHqX9dZsYsf/trnEASXh0EuywX2FDtQG', NULL, '2021-05-20 03:03:44', '2021-05-20 03:03:44', '197909142007041001', 'Wakil Ketua', NULL, 'Y', 'N', NULL),
	(7, 'SUJOKO, S.E.', 'sujoko@pa-mentok.go.id', NULL, '$2y$10$pKaNbODLZZC3Y5DuWSj7FOnrhNzutV2JNBMsmc9RIWAvK/w2amvKm', NULL, '2021-05-20 03:04:44', '2021-05-20 03:04:44', '197904052009121004', 'Sekretaris', 1, 'Y', 'N', NULL),
	(8, 'JATMIKO TRIAJI, S.T.', 'jatmiko@pa-mentok.go.id', NULL, '$2y$10$/N1PB0Xdntmtg8HeP2G9t.MQFBfrCqxdkSsviYpVEI.hsAGQ8DnIS', NULL, '2021-05-20 03:06:52', '2021-05-20 03:06:52', '198604122009121003', 'Kasubbag Perencanaan, IT, Pelaporan', 1, 'Y', 'N', NULL);
